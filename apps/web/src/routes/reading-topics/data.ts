...
export const topics: Topic[] = [
  {
    ...
    updatedAt: '2 天前更新',
    description:
      '整理行为经济学中关于人类决策偏差的经典论述，比较卡尼曼、泰勒、艾瑞里三位作者的不同视角与互补观点。',
    ...
    latestUpdate:
      '《助推》里的默认项设计，本质上是在利用系统 1 的惯性，把选择引导向一个更稳妥的方向。',
    insights: [
      ...
      {
        id: 'i4',
        title: '三本书对“非理性”的解释框架并不相同：启发式、默认项与社会比较各有重心。',
        citations: 8,
        block: '比较',
      },
    ],
  },
  {
    ...
    updatedAt: '1 周前更新',
    description:
      '从《置身事内》《小镇喧嚣》《乡土中国》中提炼中国地方政府行为逻辑，理解中央与地方的激励结构。',
    tags: ['中国经济', '地方政府', '制度分析'],
    books: [
  ...
  },
  {
    ...
    updatedAt: '2 周前更新',
    description:
      '对比《枪炮、病菌与钢铁》《崩溃》《文明的冲突》中关于文明兴衰的解释框架，辨析地理、制度与文化的权重。',
    tags: ['地理决定论', '文明史', '制度比较'],
    books: [
