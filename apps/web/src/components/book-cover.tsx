...
export function BookCover({ book, index = 0, className, rounded = 'rounded-md' }: BookCoverProps) {
  ...
  return (
    <div className={cn(className, rounded, 'flex flex-col justify-between px-2 py-1.5 font-display text-xs font-semibold shadow-sm', COVER_TONES[index % COVER_TONES.length])}>
