...
| v1.1.4 | 2026-08-09 | 统一当前状态与章节标题：M2 阅读器与阅读沉淀、M3 主题阅读均已完成；M5 阅读会话、统计与字体 API 已实现，主阅读器集成和端到端交付仍待完成 | AI |
...
13. [阅读器与笔记（已闭环）](#13-阅读器与笔记已闭环)
14. [AI 能力（S3 预留）](#14-ai-能力s3-预留)
15. [主题阅读（已完成）](#15-主题阅读已完成)
...
> 本文档为 Redesk API 接口 v1.1.4，维护中。M2 阅读器与阅读沉淀、M3 主题阅读端点均已实现；M4 AI 端点仍为预留，M5 已实现端点的主阅读器集成和端到端交付仍待完成。
